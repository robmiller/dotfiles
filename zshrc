...
plugins=(macos ruby battery bundler git-extras gem cp macports brew rake copypath copyfile)
...
__conda_setup="$('/Users/rob/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/rob/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/rob/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/rob/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
